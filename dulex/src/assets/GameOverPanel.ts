class GameOverPanel extends egret.DisplayObjectContainer{
	...
	public otherBtn:egret.Bitmap;
	public scoreText:egret.BitmapText;
	public bestScoreText:egret.TextField;
	public designation:egret.Bitmap;
	...
	//	}
		...
		if(score < 40){
			var _designation:egret.Bitmap = GameUtil.createBitmapByName('level1');
		}else if(score < 80){
			var _designation:egret.Bitmap = GameUtil.createBitmapByName('level2');
		}else{
			var _designation:egret.Bitmap = GameUtil.createBitmapByName('level3');
		}
